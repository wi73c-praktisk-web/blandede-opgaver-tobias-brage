$(document).ready(function() {
    ...
    $(".speedListElement").click(function(){
        $(".speedListElement").css("background-color", "#ffffff");
        $(this).css("background-color", "#859E4A");
        $('#chosenSpeed').html($(this).attr('id'));
    });

    $("#submitSpeed").hover(function(){
            $(this).css("background-color", "#77903c");
        }, function(){
            $(this).css("background-color", "#859E4A");
    });

    $("#submitSpeed").click(function(){
        var curSpeed = $('#curSpeed').val();
        var areSpeed = $('#chosenSpeed').html();
        switch(areSpeed) {
            case 'fifty':
                areSpeed = 50;
                break;
        ...
        speedCal(areSpeed, curSpeed, false);
    });

    function speedCal(speedLim = 80, speedCur = 100, roadwork = false) {
        var speedPer = 0;
        var speedCon = '';
